...
[PatchInfo]
public class PatchworkEqualInactivePartyExperienceType : IPatchInfo
{

    public PatchworkEqualInactivePartyExperienceType()
    {
    }
    ...
    public string PatchName { get { return "Equal Inactive Party Experience"; } }
}
