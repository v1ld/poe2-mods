...
[PatchInfo]
public class QuickLoadMostRecentSavedGameType : IPatchInfo
{

    public QuickLoadMostRecentSavedGameType()
    {
    }
    ...
    public string PatchName { get { return "QuickLoad Most Recent Save"; } }
}
